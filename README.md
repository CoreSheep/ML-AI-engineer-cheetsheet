...
`ML-AI-engineer-cheetsheet/ml-basic/`
...
### 3. 🐍 **Python Skills**
`ML-AI-engineer-cheetsheet/python/`
...
`ML-AI-engineer-cheetsheet/pandas/`
...
# Practice coding
cat ML-AI-engineer-cheetsheet/LeetCode_blind75_list.md
